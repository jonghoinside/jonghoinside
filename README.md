...
**물류 자동화 시뮬레이션 · 인터페이스 엔지니어** — SFA S/W그룹 선임
...
| 기간 | 소속 | 역할 |
|---|---|---|
| 2021.08 ~ 현재 | **SFA S/W그룹** 선임 | 물류 시뮬레이션·에뮬레이션, 최적화, 인터페이스 설계, 현장 안정화. 팀 내 시뮬레이션 모델 전담 |
| 2025.10 ~ 2026.05 | 자율제조연구 TF (파견) | AI와 현장 운영 시스템을 잇는 인터페이스 설계, AI 학습용 시뮬레이션 테스트베드 구축 |
